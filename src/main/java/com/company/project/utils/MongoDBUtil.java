...
public class MongoDBUtil {
     ...
     * @return
     */
    public FindIterable<Document>  queryDocumentIn(final MongoCollection<Document> mongoCollection,String field, List<Object> list
    ){
     ...
     * @return
     */
    public FindIterable<Document>  queryDocumentInMultiCondition(final MongoCollection<Document> mongoCollection, Map<String, Object> condition
    ){
        if(null == mongoCollection) return null;
        FindIterable<Document> findIterable = mongoCollection.find(new Document(condition));
        return findIterable;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
           ...
           /* Map<String,Object> conditions = Maps.newHashMap();
            ...
            //3、in查询
            List<Object> citys = Lists.newArrayList(1,110);
