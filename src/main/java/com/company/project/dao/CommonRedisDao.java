...
public class CommonRedisDao{
     ...
     * 前缀
     */
    private static final String KEY_PREFIX_VALUE = "mitui:bus:value:";
    private static final String KEY_PREFIX_SET = "mitui:bus:set:";
    private static final String KEY_PREFIX_LIST = "mitui:bus:list:";
    ...
    @Autowired
    public CommonRedisDao(RedisTemplate<String, String> redisTemplate) {
